    ...
    public class RepositoryFactories
    {
        ...
        private IDictionary<Type, Func<DbContext, object>> GetCodeCamperFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
                   {typeof(IRecipeRepository), dbContext => new RecipeRepository(dbContext)},
                };
        }
        ...
        /// </summary>
        /// <typeparam name="T">Group serving as the repository factory lookup key.</typeparam>
        ...
        /// </summary>
        /// <typeparam name="T">Group of the repository's root entity</typeparam>
        protected virtual Func<DbContext, object> DefaultEntityRepositoryFactory<T>() where T : class
        {
            return dbContext => new BaseEntityRepository<T>(dbContext);
        }
        ...
        /// </summary>
        /// <remarks>
        /// A dictionary key is a System.Group, typically a repository type.
